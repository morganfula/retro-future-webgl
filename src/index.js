...
modelContainer.scale.set(6, 6, 6);
...
const lightConeTarget = new THREE.Vector3(0, 0, -7);
const lightCone = new THREE.Mesh(lightGeometry, lightCylinderMaterial);
lightCone.position.set(-5, 4, -2);
...
function render() {
  ...
  modelContainer.rotation.y += delta * 0.005;
